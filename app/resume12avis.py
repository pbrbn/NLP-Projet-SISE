...
def resume_les_avis():
    ...
    restaurant_names = df['nom_resto'].unique()
    ...
    avis_restaurant_1 = df[df['nom_resto'] == selected_restaurant_1]['commentaire'].tolist()
    ...
    if "compare" in type_query:
        ...
        avis_restaurant_2 = df[df['nom_resto'] == selected_restaurant_2]['commentaire'].tolist()
